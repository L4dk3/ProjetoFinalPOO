    ...
    private void placeComponents(JPanel panel) {
        ...
        adicionarButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                } catch (Exception ex) {// ue, mas tava funcionando
                    // isso é pq a exceção não  ta sendo tratada em pesquisa
                    JOptionPane.showMessageDialog(frame, "Erro ao adicionar peixe: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        removerButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "Erro ao remover peixe: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        pesquisarButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                }catch(PeixeNaoExisteException ex){
                    resultadoPesquisa.setText(ex.getMessage());
                }
